...
const validationBook_1 = __importDefault(require("../middleware/validationBook"));
...
router.get('/books/:isbn', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!book)
        return res.status(StatusCode_1.default.NOT_FOUND).json(NotFoundMessage);
...
router.put('/books/:isbn', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { isbn } = req.params;
